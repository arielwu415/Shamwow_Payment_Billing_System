...
public class Order extends Shipping
{
    public static void main(String[] args) {
        System.out.println(checkOrder("169",1));
    }
    ...
    public static void inventoryUpdate(String id, String orderAmount) {
        int oldOrderAmount = Integer.parseInt(query("C:\\Users\\Administrator\\IdeaProjects\\Shamwow_Payment_Billing_System\\src\\application\\order.csv", id, 1, 4));
